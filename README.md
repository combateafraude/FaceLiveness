...
To add **FaceLiveness 7.5.0** to your project using **Swift Package Manager**:
...
```
4. Select the version `7.5.0` or choose "Up to Next Major" option to ensure that your project will automatically get future compatible updates.
